...
export default function Card({title, content, image, altText, buttonText, href}) {
    return (
        <div className="relative flex flex-col h-50 flex-1 justify-evenly p-5 text-xl bg-white/30 rounded-2xl shadow-2xl backdrop-blur-sm border border-black/50
">
